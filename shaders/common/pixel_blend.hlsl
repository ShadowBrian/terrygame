...
MaterialParameters_t MaterialParametersMultiblend( MaterialParameters_t a, MaterialParameters_t b, float fBlendValue, float fSoftness = 0.5 )
{
    MaterialParameters_t o;
    float fBlendfactor = ComputeBlendWeight( fBlendValue, fSoftness, b.fBlendMask );
